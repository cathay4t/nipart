...
use crate::{
    BaseInterface, EthernetInterface, InterfaceState, InterfaceType,
    NipartError, UnknownInterface,
};
...
fn copy_undefined_value(dst: &mut serde_json::Value, src: &serde_json::Value) {
