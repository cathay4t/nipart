...
pub use self::{
    ...
    ifaces::{
        ...
        VlanQosMapping, VlanRegistrationProtocol, VxlanConfig, VxlanInterface,
        WifiAuthType, WifiAuthTypeDetailed, WifiCfgInterface, WifiConfig,
        WifiPhyInterface, WifiScanResult, WifiState, WireguardConfig,
        WireguardInterface, WireguardIpAddress, WireguardPeerConfig,
    },
